...
[this,arguments]);window.console.trace()},stopPropagation:function(){this.propagate=false},preventDefault:function(){this.propagate=false},documentReady:function(a,b){if(typeof b!=="object")b={};var d={$content:a};switch(this.action){case "refresh":d.auto_ajaxify_documentReady=d.auto_sparkle_documentReady=false;break;default:break}d=c.extend(true,{},d,b);this.state.documentReady=true;this.state.stateCompletedConfig=d;return true}},State:{mode:null,el:null,isLink:false,isForm:false,documentReady:false,
stateCompletedConfig:{},stateCompleted:function(){c.Ajaxy.stateCompleted(this)},anchor:"",querystring:"",state:"",hash:"",location:"",locationShort:"",raw:{anchor:"",querystring:"",hash:"",state:"",location:"",locationShort:""},vanilla:{anchor:"",querystring:"",hash:"",state:"",location:"",locationShort:""},clean:{anchor:"",querystring:"",hash:"",state:"",location:"",locationShort:""},controller:null,Request:{url:null,data:{}},Response:{callback:null,data:{}},Error:{callback:null,data:{}},User:{data:{}}}},
isConstructed:false,aliases:{},postpone:false,Controllers:{},States:{},ignoredStates:{},currentState:{},ajaxQueue:[],data:{},redirected:false,get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!=="undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a==="object"&&d.data.extend(true,a);else d.data[a]=b},ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a,b){var d=
c.Ajaxy;if(typeof b==="undefined")b=true;a=d.ensureString(a);d=a.stripLeft(d.options.root_url).stripLeft(d.options.base_url);if(b&&d==="/")d="";return d},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a,false)},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){var b=c.Ajaxy;a=b.extractState(a);b=b.options.anchor_param_name;var d=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(d&&d.length||
false===2)d=d[1]||"";if(d===a)d="";if(!d)if((d=a.match(RegExp(b+"=([a-zA-Z0-9-_]+)"))||"")&&d.length||false===2)d=d[1]||"";return d},extractQuerystring:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||"")&&a.length||false===2)a=a[1]||"";return a},track:function(a){var b=c.Ajaxy;if(typeof pageTracker!=="undefined"){var d=a.vanilla.locationShort;b.options.debug&&window.console.debug("Ajaxy.track.analytics",[this,arguments],[d]);pageTracker._trackPageview(d)}if(typeof reinvigorate!=="undefined"&&
typeof reinvigorate.ajax_track!=="undefined"){d=a.vanilla.location;b.options.debug&&window.console.debug("Ajaxy.track.reinvigorate",[this,arguments],[d]);reinvigorate.ajax_track(d)}return true},matches:function(a,b){var d=c.Ajaxy,e=false;switch(typeof a){case "function":case "object":if(a.test){e=a.test(b);break}case "array":c.each(a,function(f,g){if(e=d.matches(g,b))return false});break;case "number":case "string":e=String(a)===b;break}return e},match:function(a){var b=c.Ajaxy,d=false;c.each(b.Controllers,
function(e,f){if(b.matches(f.matches||false,a)){d=e;return false}});return d},getController:function(a,b){var d=c.Ajaxy,e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.Controllers[a]!=="undefined")e=d.Controllers[a];else if(f==="object"&&typeof a.controller==="string")e=d.getController(a.controller,b);else if(b)e=c.extend(true,{},d.defaults.Controller);else if(b!==false){window.console.error("Ajaxy.getController: Controller does not exist",[this,arguments]);window.console.trace()}return e},
getControllerAction:function(a,b,d){var e=undefined,f=c.Ajaxy.getController(a,false);if(typeof f==="undefined"){if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller does not exist",[this,arguments]);window.console.trace()}}else{var g=typeof(f[b]||undefined);if(g==="function"||g==="object")e=f[b];else if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller Action does not exist",[this,arguments]);window.console.trace()}}return e},bind:function(){return c.Ajaxy.addControllers.apply(this,
arguments)},addController:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object")b=a;else if(typeof a==="string"&&typeof b==="function")b={controller:a,response:b};else if(typeof a==="string"&&typeof b==="object"){if(typeof b.controller==="undefined")b.controller=a}else{window.console.error("Ajaxy.addController: Unknown Controller Format",[this,arguments]);window.console.trace()}if(typeof d.Controllers[b.controller]!=="undefined"){window.console.error("Ajaxy.addController: Controller ["+
b.controller+"] has already been bound.",[this,arguments],[b]);window.console.trace();return false}b=c.prepareObject(d.defaults.Controller,b);if(!b.selector&&b.classname)b.selector="."+b.classname;d.Controllers[b.controller]=b;d.options.auto_ajaxify&&d.ajaxifyController(b);return b},addControllers:function(a){var b=c.Ajaxy;if(typeof a==="object"&&typeof a.controller==="string")window.console.warn("Ajaxy.addControllers: It seems you intended to call addController instead.",[this,arguments]);else if(typeof a===
"object"||typeof a==="array")c.each(a,function(d,e){b.addController(d,e)});return true},getState:function(a,b,d){var e=c.Ajaxy;a=e.extractState((a||{}).state||a);var f=undefined,g=typeof(a||undefined);if((g==="number"||g==="string")&&typeof e.States[a]!=="undefined")f=e.States[a];else if(b)f=e.createState(a);else if(b!==false)if(d){window.console.error("Ajaxy.getState: State does not exist",[this,arguments]);window.console.trace()}f&&e.rebuildState(f);return f},createState:function(a){var b=c.Ajaxy;
a=b.extractState((a||{}).state||a);State=c.extend(true,{},b.defaults.State,{state:a});b.rebuildState(State);return State},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,arguments]);if(typeof a==="string")a={url:a};var d=b.getState(false,true);c.extend(true,d,a);if(!(d.state||0)&&(d.url||0))d.state=b.extractState(d.url);if(!d.state)d.state="/";if(d.el){var e=c(d.el);if(e.is("form")){d.isForm=true;d.isLink=false}else if(e.is("a")){d.isForm=false;
d.isLink=true}else window.console.warn("Ajaxy.buildState: Unknown element type passed.",[this,arguments],[d.el]);delete e}b.rebuildState(d);if(d.anchor===d.state||d.anchor===d.hash)d.anchor="";if(!(d.hash||0)&&!d.raw.querystring&&(d.anchor||0)){d.hash=b.currentState.hash||"";d.querystring=d.raw.querystring;b.rebuildState(d)}if(!d.state||!d.hash&&!d.raw.querystring)window.console.warn("Ajaxy.go: No state or (hash and querystring).",[this,arguments],[d]);if(!d.mode)d.mode=d.isLink&&b.postpone?d.anchor&&
!d.raw.querystring&&d.hash===b.options.relative_url?"ignore":"postpone":d.isForm?"silent":"default";return d},rebuildState:function(a){var b=c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);var g=b.options.base_url,h=b.options.root_url;b=b.options.anchor_param_name;if(f){var i=d.queryStringToJSON();i.anchor=f;d=unescape(c.param(i));delete i}a.anchor=f;a.querystring=d;
a.hash=e;a.state=e+(d?"?"+d:"");a.locationShort=g+"#"+a.state;a.location=h+a.locationShort;a.raw.anchor="";a.raw.querystring=a.querystring.replace(RegExp("&?"+b+"=[a-zA-Z0-9-_]+","gi"),"").replace(/^&+/g,"");a.raw.hash=a.hash;a.raw.state=a.hash+(a.raw.querystring?"?"+a.raw.querystring:"");a.raw.locationShort=g+(a.raw.state?"#"+a.raw.state:"");a.raw.location=h+a.raw.locationShort;a.vanilla.anchor=a.anchor;a.vanilla.querystring=a.raw.querystring;a.vanilla.hash=a.vanilla.anchor;a.vanilla.state=a.vanilla.anchor;
a.vanilla.locationShort=g+a.raw.hash+(a.vanilla.querystring?"?"+a.vanilla.querystring:"")+(a.vanilla.anchor?"#"+a.vanilla.anchor:"");a.vanilla.location=h+a.vanilla.locationShort;a.clean.anchor="";a.clean.querystring=a.raw.querystring;a.clean.hash="";a.clean.state="";a.clean.locationShort=g+a.hash+(a.clean.querystring?"?"+a.clean.querystring:"");a.clean.location=h+a.clean.locationShort;return a},storeState:function(a){var b=c.Ajaxy,d=true;d=typeof(a||undefined);b.rebuildState(a);if(d==="object"&&typeof a.state===
"string")d=b.States[a.state]=a;else{window.console.error("Ajaxy.storeState: Unknown State Format",[this,arguments]);window.console.trace();d=false}return d},statesEquivalent:function(a,b){var d=c.Ajaxy,e=false;if(a.isForm||b.isForm)e=false;else if(a.state)c.each(d.aliases[a.hash]||[a.hash],function(f,g){if(g===b.hash&&a.raw.querystring===b.raw.querystring){e=true;return false}});return e},stateCompleted:function(a,b){var d=c.Ajaxy;if(typeof a!=="object")a={documentReady:true};a.documentReady||0||
d.options.debug&&window.console.debug("Ajaxy.stateCompleted: Called but not ready yet.",[this,arguments]);if(typeof b!=="object")b={};var e=b.$content||null;if(!(e instanceof jQuery)||!e.length)e=c(document.body);var f=c.extend({},d.options,a.stateCompletedConfig,b);d.options.debug&&window.console.debug("Ajaxy.stateCompleted:",[this,arguments],[e,f]);f.analytics&&d.track(a);if(f.auto_sparkle_documentReady&&c.Sparkle){if(f.add_sparkle_extension)f.auto_ajaxify_documentReady=false;e.sparkle()}f.auto_ajaxify_documentReady&&
e.ajaxify();if(d=a.anchor||false){a.anchor=false;c("#"+d).giveTarget().ScrollTo(f.scrollto_options)}else f.scrollto_content&&!e.is("body")&&e.ScrollTo(f.scrollto_options);return true},refresh:function(){return c.Ajaxy.go(c.History.getHash())},go:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.go:",[this,arguments]);var e=b.buildState(a);b.storeState(e);switch(e.mode){case "silent":b.stateChange(e.state);break;case "ignore":b.ignoredStates[e.vanilla.state]=e;document.location=
e.vanilla.location;break;case "postpone":document.location=e.location;break;case "default":default:d.go(e.state);break}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),i=e.getState(d,true);d=i.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",
[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",i);return false}if(typeof h==="undefined")if(b==="refresh"){window.console.warn("Ajaxy.trigger: Controller Action ["+a+"].["+b+"] does not exist. Defaulting to ["+a+"].["+b+"] Action.",[this,arguments]);return e.trigger(a,"response",i)}else{if(a==="_generic"){window.console.error("Ajaxy.trigger: Controller Action ["+a+"].["+b+"] does not exist.",[this,arguments]);window.console.trace()}else{window.console.warn("Ajaxy.trigger: Controller Action ["+
a+"].["+b+"] does not exist. Defaulting to [_generic].["+b+"] Action.",[this,arguments]);e.trigger("_generic",b,i)}return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:i});g.forward=g.trigger=function(j,m,n){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);j=j||a;m=m||b;n=n||d;e.trigger(j,m,n);return true};h.apply(g,[]);if(g.propagate===false)f=false;if(a!=="_generic"){f&&g.forward("_generic");if(b==="response"||b==="refresh"){i.documentReady=
true;i.stateCompleted()}else i.documentReady=false}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",[this,arguments]);var e=false,f=b.options.request_match instanceof RegExp&&!b.options.request_match.test(a),g=typeof b.ignoredStates[a]!=="undefined";if(f||g){b.options.debug&&window.console.debug("Ajaxy.request: We are an ignored state",[this,arguments],[a]);return true}delete f;delete g;var h=b.getState(a,true);if(b.redirected!==false)b.redirected=
...
b.currentState=h;f=h.controller||b.match(a)||undefined;h.controller=f;h.Request.url=h.Request.url||h.clean.location;b.storeState(h);b.trigger(f,"request");f={data:h.Request.data,url:h.Request.url,type:"post",success:function(k,o,q){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);if(k.Ajaxy.redirected){var l=b.extractState(k.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:l};d.go(l)}b.ajaxQueue.shift();if((l=b.ajaxQueue.pop())&&l!==a){b.ajaxQueue=[];b.stateChange(l);
return false}h.Request.XMLHttpRequest=q;h.Response.data=k;h.Error.data={};l=k.controller||h.controller||null;if(l===null){l="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[k.controller,h.controller])}if(h.Response.callback)if(h.Response.callback.apply(h,arguments)||l==="callback")return true;return b.trigger(l,"response",h)},error:function(k,o,q,l,r){b.options.debug&&window.console.debug("Ajaxy.request.error:",
[this,arguments]);b.ajaxQueue.shift();var p=b.ajaxQueue.pop();if(p&&p!==a){b.ajaxQueue=[];b.stateChange(p);return false}h.Request.XMLHttpRequest=k;h.Response.data=r;h.Error.data=l;p=r.controller||h.controller||null;if(p===null){p="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[r.controller,h.controller])}if(h.Error.callback)if(h.Error.callback.apply(h,arguments)||p==="callback")return true;return b.trigger(p,
"error",h)},complete:function(k,o){b.options.debug&&window.console.debug("Ajaxy.request.complete:",[this,arguments]);if(k)h.Request.XMLHttpRequest=k;if(o)h.Request.textStatus=o}};if(h.isForm){var i=c(h.el);if(i.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var j=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+'" >').appendTo("body").hide(),m=c('<input type="hidden" name="ajax" value="true"/>').appendTo(i),n=c('<input type="hidden" name="Ajaxy[form]" value="true"/>').appendTo(i);
j.bind("load",function(){if((this.document||this.currentDocument||this.contentWindow.document).location.href==="about:blank")return true;var k=j.contents().find(".response").val(),o=false;try{o=c.parseJSON(k)}catch(q){window.console.error("Ajaxy.request.form: Invalid Response.",[this,arguments],[k])}o?request.success(o):request.error(o);i.removeAttr("target");j.remove();m.remove();n.remove()});i.attr("target",e);i.submit();g=i.values();f.data=c.extend(true,f.data,g||{});e=true}else{g=i.values();f.data=
c.extend(true,f.data,g||{})}}g=true;h.Request=f;e||(g=b.ajax(f));return g}},prepareResponseData:function(a,b){var d=c.Ajaxy,e={},f=b.XMLHttpRequest.responseText||false;if(f)f=String(f).trim();f||(f=false);if(typeof a==="object")e=a;else{if(typeof a==="string")f=a.trim();if(!f)if(f=b.XMLHttpRequest.responseText||"")f=String(f).trim();try{e=c.parseJSON(f)}catch(g){if(!d.options.support_text){window.console.error("Ajaxy.prepareResponseData: Response has been received as text, however support_text is set to false.",
[this,arguments]);window.console.trace();return false}e=d.htmlCompat(f);var h=c(e),i=h.find("#ajaxy-head"),j=h.find("#ajaxy-body"),m=h.find("#ajaxy-title");h=h.find("#ajaxy-controller");m=m.length?m.text():"";i=i.length?i.htmlAndSelf():"";var n=j.length?j.htmlAndSelf():"";j=j.length?j.html():e;e={controller:h.length?h.text().trim():null,html:e,title:m,head:i,body:n,content:j}}}if(!(e.responseText||0))e.responseText=f;e=c.extend(true,{},d.defaults.State.Response.data,e||{});e.Ajaxy=e.Ajaxy||{};e.Ajaxy.redirected=
e.Ajaxy.redirected||false;return e},prepareErrorData:function(a,b){if(typeof a!=="object")a={};if(!(a.textStatus||0))a.textStatus=b.textStatus;if(!(a.errorThrown||0))a.errorThrown=b.errorThrown;if(!(a.error||0))a.error=b.errorThrown||(b.XMLHttpRequest.status||"Error")+": "+(b.XMLHttpRequest.statusText||"Unknown");return a},ajax:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.ajax:",[this,arguments]);var d={};d.success=a.success||function(){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.success:",
[this,arguments]);c(".error").empty()};d.error=a.error||function(f,g,h,i){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.error:",[this,arguments]);c(".error").html(i.error)};d.complete=a.complete||function(){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.complete:",[this,arguments])};delete a.success;delete a.error;delete a.complete;var e={type:"post",dataType:b.options.support_text?"text":"json"};c.extend(true,e,a);e.success=function(f,g,h){b.options.debug&&window.console.debug("Ajaxy.ajax.request.success:",
[this,arguments]);b.options.debug&&window.console.debug("Ajaxy.ajax.success:",[this,arguments]);f=b.prepareResponseData(f,{textStatus:g,XMLHttpRequest:h});var i=false;switch(true){case Boolean(typeof f.controller==="undefined"):i="No controller specified";break;case Boolean(typeof f.success!=="undefined"&&!f.success):i="Success value is set false";break;case Boolean(typeof f.error!=="undefined"&&f.error):i="Custom Error: "+String(f.error);break}if(i)return e.error.apply(this,[h,g,undefined,{error:i},
f]);return d.success.apply(this,[f,g,h])};e.error=function(f,g,h,i,j){b.options.debug&&window.console.debug("Ajaxy.ajax.request.error:",[this,arguments]);j=b.prepareResponseData(j,{XMLHttpRequest:f,errorThrown:h,textStatus:g});i=b.prepareErrorData(i,{XMLHttpRequest:f,errorThrown:h,textStatus:g});return d.error.apply(this,[f,g,i.errorThrown,i,j])};return c.ajax(e)},configure:function(a){var b=c.Ajaxy,d=c.History;a=a||{};if(typeof a!=="object")window.console.error("Ajaxy.configure: Invalid Options Passed",
...
c.Ajaxy,d=c(this),e=b.extractRelativeUrl(d.attr("href")).replace(/^\/?\.\//,"/"),f=b.extractState(e);e=b.extractAnchor(e);if("/"+e===f||e===f)e="";var g=!d.hasClass(b.options.no_log_class);d=d.data("ajaxy-controller")||null;b.go({state:f,controller:d,log:g,anchor:e,el:this});a.stopPropagation();a.preventDefault();return false},form:function(a){var b=c.Ajaxy,d=c(this),e=d.attr("disabled");if(e=e||e==="false")return false;if(d.attr("target"))return true;d=b.extractRelativeUrl(d.attr("action")).replace(/^\/?\.\//,
