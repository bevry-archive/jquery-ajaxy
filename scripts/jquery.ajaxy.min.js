...
false},preventDefault:function(){this.propagate=false},documentReady:function(a){return c.Ajaxy.stateCompleted(this.State,a)}},State:{mode:null,form:false,a:false,state:"",hash:"",anchor:"",querystring:"",location:"",locationShort:"",raw:{state:"",querystring:"",location:"",locationShort:""},vanilla:{location:"",locationShort:""},controller:null,Request:{url:null,data:{}},Response:{callback:null,data:{}},Error:{callback:null,data:{}},User:{data:{}}}},constructed:false,configured:false,onReadyHandlers:[],
postpone:false,Controllers:{},States:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a){var b=c.Ajaxy;a=b.ensureString(a);a=a.stripLeft(b.options.root_url).stripLeft(b.options.base_url);if(a==="/")a="";return a},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a)},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||
"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){var b=c.Ajaxy;a=b.extractState(a);b=b.options.anchor_param_name;var d=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(d&&d.length||false===2)d=d[1]||"";if(d===a)d="";if(!d)if((d=a.match(RegExp(b+"=([a-zA-Z0-9-_]+)"))||"")&&d.length||false===2)d=d[1]||"";return d},extractQuerystring:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||"")&&a.length||false===2)a=a[1]||"";return a},bind:function(a,b){var d=c.Ajaxy;
if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",[this,arguments]);window.console.trace();return false}if(typeof d.getController(a,false)==="undefined")d.storeController(c.prepareObject(d.defaults.Controller,{controller:a},b));else{window.console.error("Ajaxy.bind: Controller already bound.",[this,arguments]);window.console.trace();return false}if(d.options.auto_ajaxify){d.ajaxifyController(a);
return true}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),j=e.getState(d,true);d=j.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",[this,arguments]);window.console.trace();
a!=="_generic"&&e.trigger("_generic","error",j);return false}if(typeof h==="undefined"){window.console.error("Ajaxy.trigger: No Controller Action",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",j);return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:j});g.forward=g.trigger=function(i,n,k){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);i=i||a;n=n||b;k=k||d;e.trigger(i,n,k);return true};
h.apply(g,[]);if(g.propagate===false)f=false;f&&a!=="_generic"&&g.forward("_generic");return true},get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!=="undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a==="object"&&d.data.extend(true,a);else d.data[a]=b},refresh:function(){return c.Ajaxy.go(c.History.getHash())},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,arguments]);if(typeof a==="string")a={url:a};
var d=b.getState(false,true);c.extend(true,d,a);if(!(d.state||0)&&(d.url||0))d.state=b.extractState(d.url);b.rebuildState(d);if(d.anchor===d.state||d.anchor===d.hash)d.anchor="";if(!(d.hash||0)&&!d.raw.querystring&&(d.anchor||0)){d.hash=b.currentState.hash||"";d.querystring=d.raw.querystring;b.rebuildState(d)}if(!d.state||!d.hash&&!d.raw.querystring){window.console.warn("Ajaxy.go: No state or (hash and querystring)",[this,arguments],[d]);return false}delete querystring;if(!d.mode)d.mode=d.a&&b.postpone?
b.anchor&&!b.raw.querystring&&d.hash===b.options.relative_url?"default":"postpone":d.form?"silent":"default";return d},go:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.go:",[this,arguments]);var e=b.buildState(a);b.storeState(e);switch(e.mode){case "silent":b.stateChange(e.state);break;case "postpone":document.location=e.location;break;case "default":default:d.go(e.state);break}return true},getControllerAction:function(a,b,d){var e=undefined,f=c.Ajaxy.getController(a,
false);if(typeof f==="undefined"){if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller does not exist",[this,arguments]);window.console.trace()}}else{var g=typeof(f[b]||undefined);if(g==="function"||g==="object")e=f[b];else if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller Action does not exist",[this,arguments]);window.console.trace()}}return e},storeController:function(a){var b=c.Ajaxy,d=true;if(typeof(a||undefined)==="object"&&typeof a.controller===
"string")d=b.Controllers[a.controller]=a;else{window.console.error("Ajaxy.getController: Unkown Controller Format",[this,arguments]);window.console.trace();d=false}return d},getController:function(a,b){var d=c.Ajaxy,e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.Controllers[a]!=="undefined")e=d.Controllers[a];else if(f==="object"&&typeof a.controller==="string")e=d.getController(a.controller,b);else if(b)e=c.extend(true,{},d.defaults.Controller);else if(b!==false){window.console.error("Ajaxy.getController: Controller does not exist",
[this,arguments]);window.console.trace()}return e},rebuildState:function(a){var b=c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);var g=b.options.base_url,h=b.options.root_url;b=b.options.anchor_param_name;if(f){var j=d.queryStringToJSON();j.anchor=f;d=unescape(c.param(j));delete j}a.state=e+(d?"?"+d:"");a.hash=e;a.anchor=f;a.querystring=d;a.locationShort=g+"#"+a.state;
a.location=h+a.locationShort;a.raw.querystring=a.querystring.replace(RegExp("&?"+b+"=[a-zA-Z0-9-_]+"),"");a.raw.state=e;if(a.raw.querystring)a.raw.state+="?"+a.raw.querystring;a.raw.locationShort=g+"#"+a.raw.state;a.raw.location=h+a.raw.locationShort;a.vanilla.locationShort=g+a.raw.state+(a.anchor?"#"+a.anchor:"");a.vanilla.location=h+a.vanilla.locationShort;return a},storeState:function(a){var b=c.Ajaxy,d=true;d=typeof(a||undefined);b.rebuildState(a);if(d==="object"&&typeof a.state==="string")d=
b.States[a.state]=a;else{window.console.error("Ajaxy.storeState: Unkown State Format",[this,arguments]);window.console.trace();d=false}return d},getState:function(a,b){var d=c.Ajaxy;a=d.extractState((a||{}).state||a);var e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.States[a]!=="undefined")e=d.States[a];else if(b)e=d.createState(a);else if(b!==false){window.console.error("Ajaxy.getState: State does not exist",[this,arguments]);window.console.trace()}d.rebuildState(e);
...
function(f,g){if(e=d.matches(g,b))return false});break;case "number":case "string":e=String(a)===b;break}return e},match:function(a){var b=c.Ajaxy,d=false;c.each(b.Controllers,function(e,f){if(b.matches(f.matches||false,a)){d=e;return false}});return d},stateCompleted:function(a,b){var d=c.Ajaxy,e=d.options.auto_ajaxify_documentReady;(b||{}).length||0||(b=c("body"));if(d.options.auto_sparkle_documentReady&&c.Sparkle){if(d.options.add_sparkle_extension)e=false;b.sparkle()}e&&b.ajaxify();if(e=a.anchor||
false){a.anchor=false;c("#"+e).giveTarget().ScrollTo(d.options.scrollto_options)}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",[this,arguments]);var e=false,f=b.getState(a,true);if(b.redirected!==false)b.redirected=false;else{c(".target").removeClass("target");if((b.currentState.state||0)&&b.currentState.raw.state===f.raw.state&&!(f.form||b.currentState.form)){b.currentState=f;b.stateCompleted(f);b.options.debug&&window.console.debug("Ajaxy.request: There has been no considerable change",
