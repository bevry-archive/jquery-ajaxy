...
data:{}},User:{data:{}}}},constructed:false,configured:false,aliases:{},onReadyHandlers:[],postpone:false,Controllers:{},States:{},ignoredStates:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")b=true;a=d.ensureString(a);d=a.stripLeft(d.options.root_url).stripLeft(d.options.base_url);if(b&&d==="/")d=
"";return d},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a,false)},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){var b=c.Ajaxy;a=b.extractState(a);b=b.options.anchor_param_name;var d=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(d&&d.length||false===2)d=d[1]||"";if(d===a)d="";if(!d)if((d=a.match(RegExp(b+"=([a-zA-Z0-9-_]+)"))||"")&&d.length||false===2)d=d[1]||"";return d},
extractQuerystring:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||"")&&a.length||false===2)a=a[1]||"";return a},statesEquivalent:function(a,b){var d=c.Ajaxy,e=false;if(a.form||b.form)e=false;if(a.state)c.each(d.aliases[a.hash]||[a.hash],function(f,g){if(g===b.hash&&a.raw.querystring===b.raw.querystring){e=true;return false}});return e},bind:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};
else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",[this,arguments]);window.console.trace();return false}if(typeof d.getController(a,false)==="undefined")d.storeController(c.prepareObject(d.defaults.Controller,{controller:a},b));else{window.console.error("Ajaxy.bind: Controller already bound.",[this,arguments]);window.console.trace();return false}if(d.options.auto_ajaxify){d.ajaxifyController(a);return true}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&
window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),i=e.getState(d,true);d=i.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",i);return false}if(typeof h==="undefined"){window.console.error("Ajaxy.trigger: No Controller Action",
[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",i);return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:i});g.forward=g.trigger=function(j,n,m){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);j=j||a;n=n||b;m=m||d;e.trigger(j,n,m);return true};h.apply(g,[]);if(g.propagate===false)f=false;f&&a!=="_generic"&&g.forward("_generic");return true},get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!==
"undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a==="object"&&d.data.extend(true,a);else d.data[a]=b},refresh:function(){return c.Ajaxy.go(c.History.getHash())},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,arguments]);if(typeof a==="string")a={url:a};var d=b.getState(false,true);c.extend(true,d,a);if(!(d.state||0)&&(d.url||0))d.state=b.extractState(d.url);if(!d.state)d.state="/";b.rebuildState(d);
if(d.anchor===d.state||d.anchor===d.hash)d.anchor="";if(!(d.hash||0)&&!d.raw.querystring&&(d.anchor||0)){d.hash=b.currentState.hash||"";d.querystring=d.raw.querystring;b.rebuildState(d)}if(!d.state||!d.hash&&!d.raw.querystring)window.console.warn("Ajaxy.go: No state or (hash and querystring).",[this,arguments],[d]);if(!d.mode)d.mode=d.a&&b.postpone?d.anchor&&!d.raw.querystring&&d.hash===b.options.relative_url?"ignore":"postpone":d.form?"silent":"default";return d},go:function(a){var b=c.Ajaxy,d=c.History;
...
[this,arguments]);window.console.trace()}}else{var g=typeof(f[b]||undefined);if(g==="function"||g==="object")e=f[b];else if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller Action does not exist",[this,arguments]);window.console.trace()}}return e},storeController:function(a){var b=c.Ajaxy,d=true;if(typeof(a||undefined)==="object"&&typeof a.controller==="string")d=b.Controllers[a.controller]=a;else{window.console.error("Ajaxy.getController: Unkown Controller Format",[this,arguments]);
...
c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);var g=b.options.base_url,h=b.options.root_url;b=b.options.anchor_param_name;if(f){var i=d.queryStringToJSON();i.anchor=f;d=unescape(c.param(i));delete i}a.state=e+(d?"?"+d:"");a.hash=e;a.anchor=f;a.querystring=d;a.locationShort=g+"#"+a.state;a.location=h+a.locationShort;a.raw.querystring=a.querystring.replace(RegExp("&?"+
b+"=[a-zA-Z0-9-_]+"),"");a.raw.state=e;if(a.raw.querystring)a.raw.state+="?"+a.raw.querystring;a.raw.locationShort=g+"#"+a.raw.state;a.raw.location=h+a.raw.locationShort;a.vanilla.state=a.anchor;a.vanilla.locationShort=g+a.raw.state+(a.anchor?"#"+a.anchor:"");a.vanilla.location=h+a.vanilla.locationShort;return a},storeState:function(a){var b=c.Ajaxy,d=true;d=typeof(a||undefined);b.rebuildState(a);if(d==="object"&&typeof a.state==="string")d=b.States[a.state]=a;else{window.console.error("Ajaxy.storeState: Unkown State Format",
[this,arguments]);window.console.trace();d=false}return d},getState:function(a,b){var d=c.Ajaxy;a=d.extractState((a||{}).state||a);var e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.States[a]!=="undefined")e=d.States[a];else if(b)e=d.createState(a);else if(b!==false){window.console.error("Ajaxy.getState: State does not exist",[this,arguments]);window.console.trace()}d.rebuildState(e);return e},createState:function(a){var b=c.Ajaxy;a=b.extractState((a||{}).state||a);State=
c.extend(true,{},b.defaults.State,{state:a});b.rebuildState(State);return State},track:function(a){var b=c.Ajaxy;if(typeof pageTracker!=="undefined"){var d=a.vanilla.locationShort;b.options.debug&&window.console.debug("Ajaxy.track",[this,arguments],[d]);pageTracker._trackPageview(d)}return true},matches:function(a,b){var d=c.Ajaxy,e=false;switch(typeof a){case "function":case "object":if(a.test){e=a.test(b);break}case "array":c.each(a,function(f,g){if(e=d.matches(g,b))return false});break;case "number":case "string":e=
String(a)===b;break}return e},match:function(a){var b=c.Ajaxy,d=false;c.each(b.Controllers,function(e,f){if(b.matches(f.matches||false,a)){d=e;return false}});return d},stateCompleted:function(a,b,d){var e=c.Ajaxy;if(typeof a!=="object")a={};if(!(b instanceof jQuery)||!b.length)b=c(document.body);if(typeof d!=="object")d={};d=c.extend({},e.options,d);if(d.auto_sparkle_documentReady&&c.Sparkle){if(d.add_sparkle_extension)d.auto_ajaxify_documentReady=false;b.sparkle()}d.auto_ajaxify_documentReady&&
b.ajaxify();if(b=a.anchor||false){a.anchor=false;c("#"+b).giveTarget().ScrollTo(d.scrollto_options)}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",[this,arguments]);var e=false,f=b.options.request_match instanceof RegExp&&!b.options.request_match.test(a),g=typeof b.ignoredStates[a]!=="undefined";if(f||g){b.stateCompleted();b.options.debug&&window.console.debug("Ajaxy.request: We are an ignored state",[this,arguments],[a]);return true}delete f;
delete g;var h=b.getState(a,true);if(b.redirected!==false)b.redirected=false;else{c(".target").removeClass("target");if(b.statesEquivalent(h,b.currentState)){b.currentState=h;b.stateCompleted(h);b.options.debug&&window.console.debug("Ajaxy.request: There has been no considerable change",[this,arguments],[b.currentState,h,a]);return true}b.ajaxQueue.push(a);if(b.ajaxQueue.length!==1)return false;b.options.analytics&&b.track(h);b.currentState=h;f=h.controller||b.match(a)||undefined;h.controller=f;h.Request.url=
h.Request.url||h.vanilla.locationShort;b.storeState(h);b.trigger(f,"request");f={data:h.Request.data,url:h.Request.url,type:"post",success:function(k){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);k=c.extend(true,{},b.defaults.State.Response.data,k);k.Ajaxy=k.Ajaxy||{};if(k.Ajaxy.redirected){var l=b.extractState(k.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:l};d.go(l)}b.ajaxQueue.shift();if((l=b.ajaxQueue.pop())&&l!==a){b.ajaxQueue=[];b.stateChange(l);
return false}h.Response.data=k;h.Error.data={};l=k.controller||h.controller||null;if(l===null){l="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[k.controller,h.controller])}if(h.Response.callback)if(h.Response.callback.apply(h,arguments)||l==="callback")return true;return b.trigger(l,"response",h)},error:function(k,l,q,p){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);
p||(p={responseText:k.responseText.trim()||false});b.ajaxQueue.shift();var o=b.ajaxQueue.pop();if(o&&o!==a){b.ajaxQueue=[];b.stateChange(o);return false}h.Request.XMLHttpRequest=k;h.Response.data=p;h.Error.data={};o=p.controller||h.controller||null;if(o===null){o="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[p.controller,h.controller])}if(h.Error.callback)if(h.Error.callback.apply(h,arguments)||
o==="callback")return true;return b.trigger(o,"error",h)},complete:function(k){b.options.debug&&window.console.debug("Ajaxy.request.complete:",[this,arguments]);h.Request.XMLHttpRequest=k}};if(h.form){var i=c(h.form);if(i.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var j=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+'" >').appendTo("body").hide(),n=c('<input type="hidden" name="ajax" value="true"/>').appendTo(i),m=c('<input type="hidden" name="Ajaxy[form]" value="true"/>').appendTo(i);
