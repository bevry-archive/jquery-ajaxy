...
b.ajaxify=b.bind=function(){};c(function(){c(".ajaxy").removeAjaxy()})}b.bind(e);b.configured=true;b.onReady();return true}},onReady:function(a){var b=c.Ajaxy;if(typeof a==="undefined"){if(b.configured&&b.onReadyHandlers.length){c.each(b.onReadyHandlers,function(d,e){e.call(b)});b.onReadyHandlers=[]}}else if(typeof a==="function")b.configured?a.call(b):b.onReadyHandlers.push(a);return b},construct:function(){var a=c.Ajaxy,b=c.History;if(!a.constructed){a.constructed=true;b.bind(function(d){return a.stateChange(d)});
c.Sparkle&&c.Sparkle.addExtension("ajaxy",function(){c(this).ajaxify()});c.fn.ajaxy=a.fn.ajaxify;c.each(a.fn,function(d,e){c.fn[d]=e});a.onReady(function(){c(function(){a.domReady()})});return true}},domReady:function(){c.Ajaxy.options.auto_ajaxify&&c("body").ajaxify();return true},fn:{ajaxify:function(){var a=c.Ajaxy,b=c(this);c.each(a.Controllers,function(f){a.ajaxifyController(f)});if(a.options.track_all_internal_links){var d=b.findAndSelf("a[href^=/],a[href^=./]");if(a.options.root_url){var e=
c("a[href^="+a.options.root_url+"]");d=d.add(e);delete e}d=d.filter(":not(.ajaxy,.no-ajaxy)").addClass("ajaxy");delete d}a.options.track_all_anchors&&b.findAndSelf("a[href^=#]:not(.ajaxy,.no-ajaxy)").addClass("ajaxy");b.addAjaxy();return b},addAjaxy:function(){var a=c.Ajaxy,b=c(this);b.is("form,a")&&b.addClass("ajaxy");b.findAndSelf("a.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("click",a.ajaxifyHelpers.a);b.findAndSelf("form.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("submit",a.ajaxifyHelpers.form);
