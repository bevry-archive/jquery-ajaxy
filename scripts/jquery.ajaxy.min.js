...
[this,arguments],[b.currentState,h,a]);return true}b.ajaxQueue.push(a);if(b.ajaxQueue.length!==1)return false;b.options.analytics&&b.track(h);b.currentState=h;f=h.controller||b.match(a)||undefined;h.controller=f;h.Request.url=h.Request.url||h.vanilla.locationShort;b.storeState(h);b.trigger(f,"request");f={data:h.Request.data,url:h.Request.url,type:"post",success:function(l){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);l=c.extend(true,{},b.defaults.State.Response.data,
l);l.Ajaxy=l.Ajaxy||{};if(l.Ajaxy.redirected){var m=b.extractState(l.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:m};d.go(m)}b.ajaxQueue.shift();if((m=b.ajaxQueue.pop())&&m!==a){b.ajaxQueue=[];b.stateChange(m);return false}h.Response.data=l;h.Error.data={};m=l.controller||h.controller||null;if(m===null){m="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[l.controller,h.controller])}if(h.Response.callback)if(h.Response.callback.apply(h,
arguments)||m==="callback")return true;return b.trigger(m,"response",h)},error:function(l,m,r,o){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);o||(o={responseText:l.responseText.trim()||false});b.ajaxQueue.shift();var p=b.ajaxQueue.pop();if(p&&p!==a){b.ajaxQueue=[];b.stateChange(p);return false}h.Request.XMLHttpRequest=l;h.Response.data=o;h.Error.data={};p=o.controller||h.controller||null;if(p===null){p="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",
[this,arguments],[o.controller,h.controller])}if(h.Error.callback)if(h.Error.callback.apply(h,arguments)||p==="callback")return true;return b.trigger(p,"error",h)},complete:function(l){b.options.debug&&window.console.debug("Ajaxy.request.complete:",[this,arguments]);h.Request.XMLHttpRequest=l}};if(h.form){var j=c(h.form);if(j.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var i=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+
...
j.removeAttr("target");i.remove();n.remove();k.remove()});j.attr("target",e);j.submit();g=j.values();f.data=c.extend(true,f.data,g||{});e=true}else{g=j.values();f.data=c.extend(true,f.data,g||{})}}g=true;h.Request=f;e||(g=b.ajax(f));return g}},htmlCompat:function(a){return String(a).replace(/<\!DOCTYPE[^>]*>/i,"").replace(/<(html|head|body|title|meta)/gi,'<div id="ajaxy-$1"').replace(/<\/(html|head|body|title|meta)/gi,"</div")},ajax:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.ajax:",
