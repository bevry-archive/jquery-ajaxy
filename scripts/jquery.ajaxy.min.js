...
data:{}},User:{data:{}}}},constructed:false,configured:false,aliases:{},onReadyHandlers:[],postpone:false,Controllers:{},States:{},ignoredStates:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a){var b=c.Ajaxy;a=b.ensureString(a);a=a.stripLeft(b.options.root_url).stripLeft(b.options.base_url);if(a==="/")a="";return a},extractState:function(a){a=
c.Ajaxy.extractRelativeUrl(a);if(a==="")a="/";return a},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){var b=c.Ajaxy;a=b.extractState(a);b=b.options.anchor_param_name;var d=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(d&&d.length||false===2)d=d[1]||"";if(d===a)d="";if(!d)if((d=a.match(RegExp(b+"=([a-zA-Z0-9-_]+)"))||"")&&d.length||false===2)d=d[1]||"";return d},extractQuerystring:function(a){a=
c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||"")&&a.length||false===2)a=a[1]||"";return a},statesEquivalent:function(a,b){if(a.form||b.form)return false;if(a.state)c.each(Aajxy.aliases[a.hash]||[a.hash],function(d,e){if(e===b.hash&&a.raw.querystring===b.raw.querystring)return true});return false},bind:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",
