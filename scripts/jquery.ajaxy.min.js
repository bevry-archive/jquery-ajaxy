...
false},documentReady:function(a){return c.Ajaxy.stateCompleted(this.State,a)}},State:{mode:null,form:false,a:false,state:"",hash:"",anchor:"",querystring:"",location:"",controller:null,Request:{url:null,data:{}},Response:{callback:null,data:{}},Error:{callback:null,data:{}},User:{data:{}}}},constructed:false,configured:false,onReadyHandlers:[],postpone:false,Controllers:{},States:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=
String(a);break;default:b=""}return b},extractRelativeUrl:function(a){var b=c.Ajaxy;a=b.ensureString(a);a=a.stripLeft(b.options.root_url).stripLeft(b.options.base_url);if(a==="/")a="";return a},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a)},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){a=c.Ajaxy.extractState(a);var b=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(b&&b.length||
false===2)b=b[1]||"";if(b===a)b="";if(!b)if((b=a.match(/anchor=([a-zA-Z0-9-_]+)/)||"")&&b.length||false===2)b=b[1]||"";return b},extractQuerystring:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||"")&&a.length||false===2)a=a[1]||"";return a},bind:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",[this,
arguments]);window.console.trace();return false}if(typeof d.getController(a,false)==="undefined")d.storeController(c.prepareObject(d.defaults.Controller,{controller:a},b));else{window.console.error("Ajaxy.bind: Controller already bound.",[this,arguments]);window.console.trace();return false}if(d.options.auto_ajaxify){d.ajaxifyController(a);return true}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",
[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),j=e.getState(d,true);d=j.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",j);return false}if(typeof h==="undefined"){window.console.error("Ajaxy.trigger: No Controller Action",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",j);
return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:j});g.forward=g.trigger=function(i,n,k){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);i=i||a;n=n||b;k=k||d;e.trigger(i,n,k);return true};h.apply(g,[]);if(g.propagate===false)f=false;f&&a!=="_generic"&&g.forward("_generic");return true},get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!=="undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a===
"object"&&d.data.extend(true,a);else d.data[a]=b},refresh:function(){return c.Ajaxy.go(c.History.getHash())},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,arguments]);if(typeof a==="string")a={url:a};var d=b.getState(false,true);c.extend(true,d,a);if(!(d.state||0)&&(d.url||0))d.state=b.extractState(d.url);b.rebuildState(d);if(d.anchor===d.state||d.anchor===d.hash)d.anchor="";var e=(d.querystring||"").replace(/anchor=([a-zA-Z0-9-_]+)/g,"");if(!(d.hash||
0)&&!e&&(d.anchor||0)){d.hash=b.currentState.hash||"";d.querystring=e;b.rebuildState(d)}if(!d.state||!d.hash&&!e){window.console.warn("Ajaxy.go: No state or (hash and querystring)",[this,arguments],[d]);return false}delete e;if(!d.mode)d.mode=d.a&&b.postpone?"postpone":d.form?"silent":"default";return d},go:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.go:",[this,arguments]);var e=b.buildState(a);b.storeState(e);switch(e.mode){case "silent":b.stateChange(e.state);
break;case "postpone":document.location=e.location;break;case "default":default:d.go(e.state);break}return true},getControllerAction:function(a,b,d){var e=undefined,f=c.Ajaxy.getController(a,false);if(typeof f==="undefined"){if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller does not exist",[this,arguments]);window.console.trace()}}else{var g=typeof(f[b]||undefined);if(g==="function"||g==="object")e=f[b];else if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller Action does not exist",
[this,arguments]);window.console.trace()}}return e},storeController:function(a){var b=c.Ajaxy,d=true;if(typeof(a||undefined)==="object"&&typeof a.controller==="string")d=b.Controllers[a.controller]=a;else{window.console.error("Ajaxy.getController: Unkown Controller Format",[this,arguments]);window.console.trace();d=false}return d},getController:function(a,b){var d=c.Ajaxy,e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.Controllers[a]!=="undefined")e=d.Controllers[a];else if(f===
"object"&&typeof a.controller==="string")e=d.getController(a.controller,b);else if(b)e=c.extend(true,{},d.defaults.Controller);else if(b!==false){window.console.error("Ajaxy.getController: Controller does not exist",[this,arguments]);window.console.trace()}return e},rebuildState:function(a){var b=c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);a.state=e;if(f){var g=
d.queryStringToJSON();g.anchor=f;d=unescape(c.param(g));delete g}if(d)a.state+="?"+d;a.hash=e;a.anchor=f;a.querystring=d;a.location=b.options.root_url+b.options.base_url+"#"+a.state;return a},storeState:function(a){var b=c.Ajaxy,d=true;d=typeof(a||undefined);b.rebuildState(a);if(d==="object"&&typeof a.state==="string")d=b.States[a.state]=a;else{window.console.error("Ajaxy.storeState: Unkown State Format",[this,arguments]);window.console.trace();d=false}return d},getState:function(a,b){var d=c.Ajaxy;
a=d.extractState((a||{}).state||a);var e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.States[a]!=="undefined")e=d.States[a];else if(b)e=d.createState(a);else if(b!==false){window.console.error("Ajaxy.getState: State does not exist",[this,arguments]);window.console.trace()}d.rebuildState(e);return e},createState:function(a){var b=c.Ajaxy;a=b.extractState((a||{}).state||a);State=c.extend(true,{},b.defaults.State,{state:a});b.rebuildState(State);return State},track:function(a){var b=
c.Ajaxy;if(typeof pageTracker!=="undefined"){var d=b.options.base_url+(a||"?");b.options.debug&&window.console.debug("Ajaxy.track",[this,arguments],[d]);pageTracker._trackPageview(d)}return true},matches:function(a,b){var d=c.Ajaxy,e=false;switch(typeof a){case "function":case "object":if(a.test){e=a.test(b);break}case "array":c.each(a,function(f,g){if(e=d.matches(g,b))return false});break;case "number":case "string":e=String(a)===b;break}return e},match:function(a){var b=c.Ajaxy,d=false;c.each(b.Controllers,
function(e,f){if(b.matches(f.matches||false,a)){d=e;return false}});return d},stateCompleted:function(a,b){var d=c.Ajaxy,e=d.options.auto_ajaxify_documentReady;(b||{}).length||0||(b=c("body"));if(d.options.auto_sparkle_documentReady&&c.Sparkle){if(d.options.add_sparkle_extension)e=false;b.sparkle()}e&&b.ajaxify();if(e=a.anchor||false){a.anchor=false;c("#"+e).giveTarget().ScrollTo(d.options.scrollto_options)}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",
[this,arguments]);var e=false,f=b.getState(a,true);if(b.redirected!==false)b.redirected=false;else{c(".target").removeClass("target");var g=(b.currentState.querystring||"").replace(/anchor=([a-zA-Z0-9-_]+)/g,""),h=f.querystring.replace(/anchor=([a-zA-Z0-9-_]+)/g,"");if((b.currentState.state||0)&&b.currentState.hash===f.hash&&g===h&&!(f.form||b.currentState.form)){if(b.currentState.anchor!==f.anchor){b.options.debug&&window.console.debug("Ajaxy.request: There has only been an anchor change",[this,
arguments],[b.currentState,f,a]);b.stateCompleted(f)}b.currentState=f;b.options.debug&&window.console.debug("Ajaxy.request: There has been no considerable change",[this,arguments],[b.currentState,f,a]);return true}delete g;delete h;b.ajaxQueue.push(a);if(b.ajaxQueue.length!==1)return false;b.options.analytics&&b.track(a);b.currentState=f;g=f.controller||b.match(a)||undefined;f.controller=g;f.Request.url=f.Request.url||b.options.root_url+b.options.base_url+(a||"?");b.storeState(f);b.trigger(g,"request");
g={data:f.Request.data,url:f.Request.url,type:"post",success:function(l){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);l=c.extend(true,{},b.defaults.State.Response.data,l);l.Ajaxy=l.Ajaxy||{};if(l.Ajaxy.redirected){var m=b.extractState(l.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:m};d.go(m)}b.ajaxQueue.shift();if((m=b.ajaxQueue.pop())&&m!==a){b.ajaxQueue=[];b.stateChange(m);return false}f.Response.data=l;f.Error.data={};m=l.controller||f.controller||
null;if(m===null){m="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[l.controller,f.controller])}if(f.Response.callback)if(f.Response.callback.apply(f,arguments)||m==="callback")return true;return b.trigger(m,"response",f)},error:function(l,m,r,o){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);o||(o={responseText:l.responseText.trim()||false});b.ajaxQueue.shift();
var p=b.ajaxQueue.pop();if(p&&p!==a){b.ajaxQueue=[];b.stateChange(p);return false}f.Request.XMLHttpRequest=l;f.Response.data=o;f.Error.data={};p=o.controller||f.controller||null;if(p===null){p="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[o.controller,f.controller])}if(f.Error.callback)if(f.Error.callback.apply(f,arguments)||p==="callback")return true;return b.trigger(p,"error",f)},complete:function(l){b.options.debug&&
window.console.debug("Ajaxy.request.complete:",[this,arguments]);f.Request.XMLHttpRequest=l}};if(f.form){var j=c(f.form);if(j.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var i=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+'" >').appendTo("body").hide(),n=c('<input type="hidden" name="ajax" value="true"/>').appendTo(j),k=c('<input type="hidden" name="Ajaxy[form]" value="true"/>').appendTo(j);i.bind("load",function(){if((this.document||
this.currentDocument||this.contentWindow.document).location.href==="about:blank")return true;var l=i.contents().find(".response").val(),m=false;try{m=c.parseJSON(l)}catch(r){window.console.error("Ajaxy.request.form: Invalid Response.",[this,arguments],[l])}m?request.success(m):request.error(m);j.removeAttr("target");i.remove();n.remove();k.remove()});j.attr("target",e);j.submit();h=j.values();g.data=c.extend(true,g.data,h||{});e=true}else{h=j.values();g.data=c.extend(true,g.data,h||{})}}h=true;f.Request=
g;e||(h=b.ajax(g));return h}},htmlCompat:function(a){return String(a).replace(/<\!DOCTYPE[^>]*>/i,"").replace(/<(html|head|body|title|meta)/gi,'<div id="ajaxy-$1"').replace(/<\/(html|head|body|title|meta)/gi,"</div")},ajax:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.ajax:",[this,arguments]);var d={};d.success=a.success||function(){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.success:",[this,arguments]);c(".error").empty()};d.error=a.error||function(f,g,h){b.options.debug&&
...
f)try{h=c.parseJSON(f)}catch(j){h=b.htmlCompat(f);var i=c(h),n=i.find("#ajaxy-head"),k=i.find("#ajaxy-body"),l=i.find("#ajaxy-title");i=i.find("#ajaxy-controller");l=l.length?l.text():"";n=n.length?n.htmlAndSelf():"";var m=k.length?k.htmlAndSelf():"";k=k.length?k.html():h;h={controller:i.length?i.text().trim():null,responseText:f,html:h,title:l,head:n,body:m,content:k}}else h=f;b.options.debug&&window.console.debug("Ajaxy.ajax.success:",[this,arguments]);if(typeof h.controller==="undefined"&&(typeof h.success!==
...
"";if(b.options.base_url==="/")b.options.base_url="";if(b.options.relative_url==="/")b.options.relative_url="";b.options.debug&&window.console.debug("Ajaxy.configure:",[this,arguments]);if(b.options.relative_url&&b.options.relative_url!==null)if(b.options.redirect===true){var f=b.options.root_url+b.options.base_url+"#"+b.options.relative_url;if(d=d.getHash())f+="?anchor="+d;document.location=f}else if(b.options.redirect==="postpone")b.postpone=true;else if(b.options.redirect==="disable"){b.addAjaxy=
b.ajaxify=b.bind=function(){};c(function(){c(".ajaxy").removeAjaxy()})}b.bind(e);b.configured=true;b.onReady();return true}},onReady:function(a){var b=c.Ajaxy;if(typeof a==="undefined"){if(b.configured&&b.onReadyHandlers.length){c.each(b.onReadyHandlers,function(d,e){e.call(b)});b.onReadyHandlers=[]}}else if(typeof a==="function")b.configured?a.call(b):b.onReadyHandlers.push(onReadyHandlers);return b},construct:function(){var a=c.Ajaxy,b=c.History;if(!a.constructed){a.constructed=true;b.bind(function(d){return a.stateChange(d)});
c.Sparkle&&c.Sparkle.addExtension("ajaxy",function(){c(this).ajaxify()});c.fn.ajaxy=a.fn.ajaxify;c.each(a.fn,function(d,e){c.fn[d]=e});c(function(){a.domReady();b.domReady()});return true}},domReady:function(){c.Ajaxy.options.auto_ajaxify&&c("body").ajaxify();return true},fn:{ajaxify:function(){var a=c.Ajaxy,b=c(this);c.each(a.Controllers,function(f){a.ajaxifyController(f)});if(a.options.track_all_internal_links){var d=b.findAndSelf("a[href^=/],a[href^=./]");if(a.options.root_url){var e=c("a[href^="+
