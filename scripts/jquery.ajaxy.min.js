...
if(a===f)d=true;else if(b.is("input"))if(!c.browser.msie){e.type=a;if(e.type!==f)d=true}return d}})(jQuery);
...
$target:d});if(config.durationMode==="all")config.duration/=f.length;b.scroll(f,config);return this},construct:function(a){var b=c.ScrollTo;c.fn.ScrollTo=b.fn;b.config=c.extend(b.config,a);return this}};c.ScrollTo.construct()}})(jQuery);
...
(function(c){c(document.body).addClass("js");if(c.Ajaxy)window.console.warn("$.Ajaxy has already been defined...");else{c.Ajaxy={options:{root_url:"",base_url:"",relative_url:"",request_match:false,no_log_class:"ajaxy-no_log",redirect:false,relative_as_base:true,support_text:true,analytics:true,auto_ajaxify:true,auto_ajaxify_documentReady:true,auto_sparkle_documentReady:true,add_sparkle_extension:true,scrollto_options:{duration:400,easing:"swing"},anchor_param_name:"anchor",track_all_anchors:false,
track_all_internal_links:false,debug:true,aliases:[["","/"]],Controllers:{}},defaults:{Controller:{selector:null,matches:null,controller:null,response:null,request:null,error:null},Action:{propagate:true,action:null,state:null,State:null,controller:null,Controller:null,forward:function(){window.console.error("Ajaxy.Action.forward: Forward never defined.",[this,arguments]);window.console.trace()},trigger:function(){window.console.error("Ajaxy.Action.trigger: Trigger never defined.",[this,arguments]);
window.console.trace()},stopPropagation:function(){this.propagate=false},preventDefault:function(){this.propagate=false},documentReady:function(a,b){return c.Ajaxy.stateCompleted(this.State,a,b)}},State:{mode:null,form:false,a:false,state:"",hash:"",anchor:"",querystring:"",location:"",locationShort:"",raw:{state:"",querystring:"",location:"",locationShort:""},vanilla:{state:"",location:"",locationShort:""},controller:null,Request:{url:null,data:{}},Response:{callback:null,data:{}},Error:{callback:null,
data:{}},User:{data:{}}}},constructed:false,configured:false,aliases:{},onReadyHandlers:[],postpone:false,Controllers:{},States:{},ignoredStates:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a){var b=c.Ajaxy;a=b.ensureString(a);a=a.stripLeft(b.options.root_url).stripLeft(b.options.base_url);if(a==="/")a="";return a},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a)},
extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/^([^#?]*)/)||"")&&a.length||false===2)a=a[1]||"";return a},extractAnchor:function(a){var b=c.Ajaxy;a=b.extractState(a);b=b.options.anchor_param_name;var d=a.replace(/[^#]+#/g,"#").match(/#+([^#\?]*)/)||"";if(d&&d.length||false===2)d=d[1]||"";if(d===a)d="";if(!d)if((d=a.match(RegExp(b+"=([a-zA-Z0-9-_]+)"))||"")&&d.length||false===2)d=d[1]||"";return d},extractQuerystring:function(a){a=c.Ajaxy.extractState(a);if((a=a.match(/\?(.*)$/)||
"")&&a.length||false===2)a=a[1]||"";return a},statesEquivalent:function(a,b){var d=c.Ajaxy;if(a.form||b.form)return false;if(a.state)c.each(d.aliases[a.hash]||[a.hash],function(e,f){if(f===b.hash&&a.raw.querystring===b.raw.querystring)return true});return false},bind:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",
[this,arguments]);window.console.trace();return false}if(typeof d.getController(a,false)==="undefined")d.storeController(c.prepareObject(d.defaults.Controller,{controller:a},b));else{window.console.error("Ajaxy.bind: Controller already bound.",[this,arguments]);window.console.trace();return false}if(d.options.auto_ajaxify){d.ajaxifyController(a);return true}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",
[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),i=e.getState(d,true);d=i.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",i);return false}if(typeof h==="undefined"){window.console.error("Ajaxy.trigger: No Controller Action",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",i);
return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:i});g.forward=g.trigger=function(j,n,m){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);j=j||a;n=n||b;m=m||d;e.trigger(j,n,m);return true};h.apply(g,[]);if(g.propagate===false)f=false;f&&a!=="_generic"&&g.forward("_generic");return true},get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!=="undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a===
"object"&&d.data.extend(true,a);else d.data[a]=b},refresh:function(){return c.Ajaxy.go(c.History.getHash())},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,arguments]);if(typeof a==="string")a={url:a};var d=b.getState(false,true);c.extend(true,d,a);if(!(d.state||0)&&(d.url||0))d.state=b.extractState(d.url);if(!d.state)d.state="/";b.rebuildState(d);if(d.anchor===d.state||d.anchor===d.hash)d.anchor="";if(!(d.hash||0)&&!d.raw.querystring&&(d.anchor||
0)){d.hash=b.currentState.hash||"";d.querystring=d.raw.querystring;b.rebuildState(d)}if(!d.state||!d.hash&&!d.raw.querystring)window.console.warn("Ajaxy.go: No state or (hash and querystring).",[this,arguments],[d]);if(!d.mode)d.mode=d.a&&b.postpone?d.anchor&&!d.raw.querystring&&d.hash===b.options.relative_url?"ignore":"postpone":d.form?"silent":"default";return d},go:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.go:",[this,arguments]);var e=b.buildState(a);b.storeState(e);
switch(e.mode){case "silent":b.stateChange(e.state);break;case "ignore":b.ignoredStates[e.vanilla.state]=true;document.location=e.vanilla.location;break;case "postpone":document.location=e.location;break;case "default":default:d.go(e.state);break}return true},getControllerAction:function(a,b,d){var e=undefined,f=c.Ajaxy.getController(a,false);if(typeof f==="undefined"){if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller does not exist",[this,arguments]);window.console.trace()}}else{var g=
typeof(f[b]||undefined);if(g==="function"||g==="object")e=f[b];else if(d!==false){window.console.error("Ajaxy.getControllerAction: Controller Action does not exist",[this,arguments]);window.console.trace()}}return e},storeController:function(a){var b=c.Ajaxy,d=true;if(typeof(a||undefined)==="object"&&typeof a.controller==="string")d=b.Controllers[a.controller]=a;else{window.console.error("Ajaxy.getController: Unkown Controller Format",[this,arguments]);window.console.trace();d=false}return d},getController:function(a,
b){var d=c.Ajaxy,e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.Controllers[a]!=="undefined")e=d.Controllers[a];else if(f==="object"&&typeof a.controller==="string")e=d.getController(a.controller,b);else if(b)e=c.extend(true,{},d.defaults.Controller);else if(b!==false){window.console.error("Ajaxy.getController: Controller does not exist",[this,arguments]);window.console.trace()}return e},rebuildState:function(a){var b=c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||
b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);var g=b.options.base_url,h=b.options.root_url;b=b.options.anchor_param_name;if(f){var i=d.queryStringToJSON();i.anchor=f;d=unescape(c.param(i));delete i}a.state=e+(d?"?"+d:"");a.hash=e;a.anchor=f;a.querystring=d;a.locationShort=g+"#"+a.state;a.location=h+a.locationShort;a.raw.querystring=a.querystring.replace(RegExp("&?"+b+"=[a-zA-Z0-9-_]+"),"");a.raw.state=e;if(a.raw.querystring)a.raw.state+=
"?"+a.raw.querystring;a.raw.locationShort=g+"#"+a.raw.state;a.raw.location=h+a.raw.locationShort;a.vanilla.state=a.anchor;a.vanilla.locationShort=g+a.raw.state+(a.anchor?"#"+a.anchor:"");a.vanilla.location=h+a.vanilla.locationShort;return a},storeState:function(a){var b=c.Ajaxy,d=true;d=typeof(a||undefined);b.rebuildState(a);if(d==="object"&&typeof a.state==="string")d=b.States[a.state]=a;else{window.console.error("Ajaxy.storeState: Unkown State Format",[this,arguments]);window.console.trace();d=
false}return d},getState:function(a,b){var d=c.Ajaxy;a=d.extractState((a||{}).state||a);var e=undefined,f=typeof(a||undefined);if((f==="number"||f==="string")&&typeof d.States[a]!=="undefined")e=d.States[a];else if(b)e=d.createState(a);else if(b!==false){window.console.error("Ajaxy.getState: State does not exist",[this,arguments]);window.console.trace()}d.rebuildState(e);return e},createState:function(a){var b=c.Ajaxy;a=b.extractState((a||{}).state||a);State=c.extend(true,{},b.defaults.State,{state:a});
b.rebuildState(State);return State},track:function(a){var b=c.Ajaxy;if(typeof pageTracker!=="undefined"){var d=a.vanilla.locationShort;b.options.debug&&window.console.debug("Ajaxy.track",[this,arguments],[d]);pageTracker._trackPageview(d)}return true},matches:function(a,b){var d=c.Ajaxy,e=false;switch(typeof a){case "function":case "object":if(a.test){e=a.test(b);break}case "array":c.each(a,function(f,g){if(e=d.matches(g,b))return false});break;case "number":case "string":e=String(a)===b;break}return e},
match:function(a){var b=c.Ajaxy,d=false;c.each(b.Controllers,function(e,f){if(b.matches(f.matches||false,a)){d=e;return false}});return d},stateCompleted:function(a,b,d){var e=c.Ajaxy;if(typeof a!=="object")a={};if(!(b instanceof jQuery)||!b.length)b=c(document.body);if(typeof d!=="object")d={};d=c.extend({},e.options,d);if(d.auto_sparkle_documentReady&&c.Sparkle){if(d.add_sparkle_extension)d.auto_ajaxify_documentReady=false;b.sparkle()}d.auto_ajaxify_documentReady&&b.ajaxify();if(b=a.anchor||false){a.anchor=
false;c("#"+b).giveTarget().ScrollTo(d.scrollto_options)}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",[this,arguments]);var e=false,f=b.options.request_match instanceof RegExp&&!b.options.request_match.test(a),g=typeof b.ignoredStates[a]!=="undefined";if(f||g){b.stateCompleted();b.options.debug&&window.console.debug("Ajaxy.request: We are an ignored state",[this,arguments],[a]);return true}delete f;delete g;var h=b.getState(a,true);
if(b.redirected!==false)b.redirected=false;else{c(".target").removeClass("target");if(b.statesEquivalent(h,b.currentState)){b.currentState=h;b.stateCompleted(h);b.options.debug&&window.console.debug("Ajaxy.request: There has been no considerable change",[this,arguments],[b.currentState,h,a]);return true}b.ajaxQueue.push(a);if(b.ajaxQueue.length!==1)return false;b.options.analytics&&b.track(h);b.currentState=h;f=h.controller||b.match(a)||undefined;h.controller=f;h.Request.url=h.Request.url||h.vanilla.locationShort;
b.storeState(h);b.trigger(f,"request");f={data:h.Request.data,url:h.Request.url,type:"post",success:function(k){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);k=c.extend(true,{},b.defaults.State.Response.data,k);k.Ajaxy=k.Ajaxy||{};if(k.Ajaxy.redirected){var l=b.extractState(k.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:l};d.go(l)}b.ajaxQueue.shift();if((l=b.ajaxQueue.pop())&&l!==a){b.ajaxQueue=[];b.stateChange(l);return false}h.Response.data=k;h.Error.data=
{};l=k.controller||h.controller||null;if(l===null){l="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[k.controller,h.controller])}if(h.Response.callback)if(h.Response.callback.apply(h,arguments)||l==="callback")return true;return b.trigger(l,"response",h)},error:function(k,l,q,p){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);p||(p={responseText:k.responseText.trim()||
false});b.ajaxQueue.shift();var o=b.ajaxQueue.pop();if(o&&o!==a){b.ajaxQueue=[];b.stateChange(o);return false}h.Request.XMLHttpRequest=k;h.Response.data=p;h.Error.data={};o=p.controller||h.controller||null;if(o===null){o="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[p.controller,h.controller])}if(h.Error.callback)if(h.Error.callback.apply(h,arguments)||o==="callback")return true;return b.trigger(o,
"error",h)},complete:function(k){b.options.debug&&window.console.debug("Ajaxy.request.complete:",[this,arguments]);h.Request.XMLHttpRequest=k}};if(h.form){var i=c(h.form);if(i.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var j=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+'" >').appendTo("body").hide(),n=c('<input type="hidden" name="ajax" value="true"/>').appendTo(i),m=c('<input type="hidden" name="Ajaxy[form]" value="true"/>').appendTo(i);
j.bind("load",function(){if((this.document||this.currentDocument||this.contentWindow.document).location.href==="about:blank")return true;var k=j.contents().find(".response").val(),l=false;try{l=c.parseJSON(k)}catch(q){window.console.error("Ajaxy.request.form: Invalid Response.",[this,arguments],[k])}l?request.success(l):request.error(l);i.removeAttr("target");j.remove();n.remove();m.remove()});i.attr("target",e);i.submit();g=i.values();f.data=c.extend(true,f.data,g||{});e=true}else{g=i.values();f.data=
c.extend(true,f.data,g||{})}}g=true;h.Request=f;e||(g=b.ajax(f));return g}},htmlCompat:function(a){return String(a).replace(/<\!DOCTYPE[^>]*>/i,"").replace(/<(html|head|body|title|meta)/gi,'<div id="ajaxy-$1"').replace(/<\/(html|head|body|title|meta)/gi,"</div")},ajax:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.ajax:",[this,arguments]);var d={};d.success=a.success||function(){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.success:",[this,arguments]);c(".error").empty()};
d.error=a.error||function(f,g,h){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.error:",[this,arguments]);c(".error").html(h)};d.complete=a.complete||function(){b.options.debug&&window.console.debug("Ajaxy.ajax.callbacks.complete:",[this,arguments])};delete a.success;delete a.error;delete a.complete;var e={type:"post",dataType:b.options.support_text?"text":"json"};c.extend(true,e,a);e.success=function(f,g){b.options.debug&&window.console.debug("Ajaxy.ajax.request.success:",[this,arguments]);
var h={};if(typeof f!=="object"&&b.options.support_text&&f)try{h=c.parseJSON(f)}catch(i){h=b.htmlCompat(f);var j=c(h),n=j.find("#ajaxy-head"),m=j.find("#ajaxy-body"),k=j.find("#ajaxy-title");j=j.find("#ajaxy-controller");k=k.length?k.text():"";n=n.length?n.htmlAndSelf():"";var l=m.length?m.htmlAndSelf():"";m=m.length?m.html():h;h={controller:j.length?j.text().trim():null,responseText:f,html:h,title:k,head:n,body:l,content:m}}else h=f;b.options.debug&&window.console.debug("Ajaxy.ajax.success:",[this,
arguments]);if(typeof h.controller==="undefined"&&(typeof h.success!=="undefined"&&!h.success||typeof h.error!=="undefined"&&h.error))return d.error.apply(this,[null,g,h.error||true,h]);return d.success.apply(this,[h,g])};e.error=function(f,g,h){b.options.debug&&window.console.debug("Ajaxy.ajax.request.error:",[this,arguments]);var i=f.responseText||false;if(i)i=i.trim();i||(i=false);var j={error:h||true,responseText:i};if(i)try{j=c.parseJSON(i)}catch(n){}finally{return this.success.apply(this,[j,
g])}return d.error.apply(this,[f,g,h,j])};return c.ajax(e)},stateChange:function(a){c.Ajaxy.request(a)},configure:function(a){var b=c.Ajaxy,d=c.History;a=a||{};if(typeof a!=="object")window.console.error("Ajaxy.configure: Invalid Options Passed",[this,arguments]);else{var e;if(typeof a.Controllers==="object"){e=a.Controllers;delete a.Controllers}else if(typeof a.controllers==="object"){e=a.controllers;delete a.controllers}else{e=a;a={}}b.options=c.extend(true,b.options,a.options||a);b.options.root_url=
(b.options.root_url||document.location.protocol.toString()+"//"+document.location.hostname.toString()).replace(/\/+$/,"")+"/";b.options.base_url=b.options.base_url||"";b.options.relative_url=b.extractState(b.options.relative_url||document.location.pathname.toString());if(b.options.relative_as_base)if(b.options.base_url.length===0){b.options.base_url=b.options.relative_url;b.options.relative_url=""}b.options.root_url=b.options.root_url.replace(/\/+$/,"");b.options.base_url=b.options.base_url.replace(/\/+$/,
"");b.options.relative_url=b.extractRelativeUrl(b.options.relative_url);if(b.options.root_url==="/")b.options.root_url="";if(b.options.base_url==="/")b.options.base_url="";if(b.options.relative_url==="/")b.options.relative_url="";if(b.options.request_match===true){var f=[];b.options.root_url&&f.push("^"+b.options.root_url+b.options.base_url);b.options.base_url&&f.push("^"+b.options.base_url);f.push("^/");b.options.request_match=RegExp(f.join("|"),"i");delete f}b.options.debug&&window.console.debug("Ajaxy.configure:",
[this,arguments]);if(b.options.relative_url&&b.options.relative_url!==null)if(b.options.redirect===true){f=b.options.root_url+b.options.base_url+"#"+b.options.relative_url;if(d=d.getHash())f+="?anchor="+d;document.location=f}else if(b.options.redirect==="postpone")b.postpone=true;else if(b.options.redirect==="disable"){b.addAjaxy=b.ajaxify=b.bind=function(){};c(function(){c(".ajaxy").removeAjaxy()})}b.aliases=[];c.each(b.options.aliases,function(g,h){c.each(h,function(i,j){b.aliases[j]=h})});b.bind(e);
b.configured=true;b.onReady();return true}},onReady:function(a){var b=c.Ajaxy;if(typeof a==="undefined"){if(b.configured&&b.onReadyHandlers.length){c.each(b.onReadyHandlers,function(d,e){e.call(b)});b.onReadyHandlers=[]}}else if(typeof a==="function")b.configured?a.call(b):b.onReadyHandlers.push(a);return b},construct:function(){var a=c.Ajaxy,b=c.History;if(!a.constructed){a.constructed=true;b.bind(function(d){return a.stateChange(d)});c.Sparkle&&c.Sparkle.addExtension("ajaxy",function(){c(this).ajaxify()});
c.fn.ajaxy=a.fn.ajaxify;c.each(a.fn,function(d,e){c.fn[d]=e});a.onReady(function(){c(function(){a.domReady()})});return true}},domReady:function(){c.Ajaxy.options.auto_ajaxify&&c("body").ajaxify();return true},fn:{ajaxify:function(){var a=c.Ajaxy,b=c(this);c.each(a.Controllers,function(f){a.ajaxifyController(f)});if(a.options.track_all_internal_links){var d=b.findAndSelf("a[href^=/],a[href^=./]");if(a.options.root_url){var e=c("a[href^="+a.options.root_url+"]");d=d.add(e);delete e}d=d.filter(":not(.ajaxy,.no-ajaxy)").addClass("ajaxy");
delete d}a.options.track_all_anchors&&b.findAndSelf("a[href^=#]:not(.ajaxy,.no-ajaxy)").addClass("ajaxy");b.addAjaxy();return b},addAjaxy:function(){var a=c.Ajaxy,b=c(this);b.is("form,a")&&b.addClass("ajaxy");b.findAndSelf("a.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("click",a.ajaxifyHelpers.a);b.findAndSelf("form.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("submit",a.ajaxifyHelpers.form);return b},removeAjaxy:function(a){var b=c.Ajaxy,d=c(this);a=c.extend({permanently:true},a);var e=
d.findAndSelf("a.ajaxy").removeClass("ajaxy ajaxy-has").unbind("click",b.ajaxifyHelpers.a);b=d.findAndSelf("form.ajaxy").removeClass("ajaxy ajaxy-has").unbind("submit",b.ajaxifyHelpers.form);a.permanently&&e.add(b).addClass("no-ajaxy");return d}},ajaxifyController:function(a){var b=c.Ajaxy.getController(a);if(b&&(b.selector||0))c(function(){c(b.selector).data("ajaxy-controller",a).addAjaxy()});return true},ajaxifyHelpers:{a:function(a){var b=c.Ajaxy,d=c(this),e=b.extractRelativeUrl(d.attr("href")).replace(/^\/?\.\//,
"/"),f=b.extractState(e);e=b.extractAnchor(e);if("/"+e===f||e===f)e="";var g=!d.hasClass(b.options.no_log_class);d=d.data("ajaxy-controller")||null;b.go({state:f,controller:d,log:g,anchor:e,a:this});a.stopPropagation();a.preventDefault();return false},form:function(a){var b=c.Ajaxy,d=c(this),e=d.attr("disabled");if(e=e||e==="false")return false;if(d.attr("target"))return true;d=b.extractRelativeUrl(d.attr("action")).replace(/^\/?\.\//,"/");d=b.extractState(d);b.go({state:d,form:this});a.stopPropagation();
a.preventDefault();return false}}};c.Ajaxy.construct()}})(jQuery);
