...
(function(c){c(document.body).addClass("js");if(c.Ajaxy)window.console.warn("$.Ajaxy has already been defined...");else{c.Ajaxy={options:{root_url:"",base_url:"",relative_url:"",no_log_class:"ajaxy-no_log",redirect:false,relative_as_base:true,support_text:true,analytics:true,auto_ajaxify:true,auto_ajaxify_documentReady:true,auto_sparkle_documentReady:true,add_sparkle_extension:true,scrollto_options:{duration:400,easing:"swing"},anchor_param_name:"anchor",track_all_anchors:false,track_all_internal_links:false,
debug:true,Controllers:{}},defaults:{Controller:{selector:null,matches:null,controller:null,response:null,request:null,error:null},Action:{propagate:true,action:null,state:null,State:null,controller:null,Controller:null,forward:function(){window.console.error("Ajaxy.Action.forward: Forward never defined.",[this,arguments]);window.console.trace()},trigger:function(){window.console.error("Ajaxy.Action.trigger: Trigger never defined.",[this,arguments]);window.console.trace()},stopPropagation:function(){this.propagate=
false},preventDefault:function(){this.propagate=false},documentReady:function(a){return c.Ajaxy.stateCompleted(this.State,a)}},State:{mode:null,form:false,a:false,state:"",hash:"",anchor:"",querystring:"",location:"",locationShort:"",raw:{state:"",querystring:"",location:"",locationShort:""},vanilla:{state:"",location:"",locationShort:""},controller:null,Request:{url:null,data:{}},Response:{callback:null,data:{}},Error:{callback:null,data:{}},User:{data:{}}}},constructed:false,configured:false,onReadyHandlers:[],
postpone:false,Controllers:{},States:{},ignoredStates:{},currentState:{},ajaxQueue:[],data:{},redirected:false,ensureString:function(a){var b="";switch(typeof a){case "number":case "string":b=String(a);break;default:b=""}return b},extractRelativeUrl:function(a){var b=c.Ajaxy;a=b.ensureString(a);a=a.stripLeft(b.options.root_url).stripLeft(b.options.base_url);if(a==="/")a="";return a},extractState:function(a){return c.Ajaxy.extractRelativeUrl(a)},extractHash:function(a){a=c.Ajaxy.extractState(a);if((a=
...
b){var d=c.Ajaxy;if(typeof b==="undefined"&&typeof a==="object"){c.each(a,d.bind);return true}else if(typeof b==="function")b={response:b};else if(typeof b!=="object"){window.console.error("Ajaxy.bind: Unknown option type",[this,arguments]);window.console.trace();return false}if(typeof d.getController(a,false)==="undefined")d.storeController(c.prepareObject(d.defaults.Controller,{controller:a},b));else{window.console.error("Ajaxy.bind: Controller already bound.",[this,arguments]);window.console.trace();
return false}if(d.options.auto_ajaxify){d.ajaxifyController(a);return true}return true},trigger:function(a,b,d){var e=c.Ajaxy;e.options.debug&&window.console.debug("Ajaxy.trigger: ",[this,arguments]);var f=true;if(!a){window.console.warn("Ajaxy.trigger: No controller was passed, reset to _generic.",[this,arguments]);a="_generic"}var g=e.getController(a),h=e.getControllerAction(a,b,false),j=e.getState(d,true);d=j.state||undefined;if(typeof g==="undefined"){window.console.error("Ajaxy.trigger: Controller does not exist",
[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",j);return false}if(typeof h==="undefined"){window.console.error("Ajaxy.trigger: No Controller Action",[this,arguments]);window.console.trace();a!=="_generic"&&e.trigger("_generic","error",j);return false}g=c.extend(true,{},e.defaults.Action,{action:b,controller:a,Controller:g,state:d,State:j});g.forward=g.trigger=function(i,n,k){e.options.debug&&window.console.debug("Ajaxy.Action.trigger:",[this,arguments]);i=i||
a;n=n||b;k=k||d;e.trigger(i,n,k);return true};h.apply(g,[]);if(g.propagate===false)f=false;f&&a!=="_generic"&&g.forward("_generic");return true},get:function(a){var b=c.Ajaxy;if(typeof b.data[a]!=="undefined")return b.data[a]},set:function(a,b){var d=c.Ajaxy;if(typeof b==="undefined")typeof a==="object"&&d.data.extend(true,a);else d.data[a]=b},refresh:function(){return c.Ajaxy.go(c.History.getHash())},buildState:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.buildState:",[this,
...
else if(b)e=c.extend(true,{},d.defaults.Controller);else if(b!==false){window.console.error("Ajaxy.getController: Controller does not exist",[this,arguments]);window.console.trace()}return e},rebuildState:function(a){var b=c.Ajaxy,d=b.extractState(a.state),e=b.ensureString(a.hash)||b.extractHash(d),f=b.ensureString(a.anchor)||b.extractAnchor(d);d=b.ensureString(a.querystring)||b.extractQuerystring(d);var g=b.options.base_url,h=b.options.root_url;b=b.options.anchor_param_name;if(f){var j=d.queryStringToJSON();
j.anchor=f;d=unescape(c.param(j));delete j}a.state=e+(d?"?"+d:"");a.hash=e;a.anchor=f;a.querystring=d;a.locationShort=g+"#"+a.state;a.location=h+a.locationShort;a.raw.querystring=a.querystring.replace(RegExp("&?"+b+"=[a-zA-Z0-9-_]+"),"");a.raw.state=e;if(a.raw.querystring)a.raw.state+="?"+a.raw.querystring;a.raw.locationShort=g+"#"+a.raw.state;a.raw.location=h+a.raw.locationShort;a.vanilla.state=a.anchor;a.vanilla.locationShort=g+a.raw.state+(a.anchor?"#"+a.anchor:"");a.vanilla.location=h+a.vanilla.locationShort;
...
c(document.body);var e=d.options.auto_ajaxify_documentReady;if(d.options.auto_sparkle_documentReady&&c.Sparkle){if(d.options.add_sparkle_extension)e=false;b.sparkle()}e&&b.ajaxify();if(e=a.anchor||false){a.anchor=false;c("#"+e).giveTarget().ScrollTo(d.options.scrollto_options)}return true},request:function(a){var b=c.Ajaxy,d=c.History;b.options.debug&&window.console.debug("Ajaxy.request:",[this,arguments]);var e=false;if(typeof b.ignoredStates[a]!=="undefined"){b.stateCompleted();b.options.debug&&
window.console.debug("Ajaxy.request: We are an ignored state",[this,arguments],[a]);return true}var f=b.getState(a,true);if(b.redirected!==false)b.redirected=false;else{c(".target").removeClass("target");if((b.currentState.state||0)&&b.currentState.raw.state===f.raw.state&&!(f.form||b.currentState.form)){b.currentState=f;b.stateCompleted(f);b.options.debug&&window.console.debug("Ajaxy.request: There has been no considerable change",[this,arguments],[b.currentState,f,a]);return true}b.ajaxQueue.push(a);
if(b.ajaxQueue.length!==1)return false;b.options.analytics&&b.track(f);b.currentState=f;var g=f.controller||b.match(a)||undefined;f.controller=g;f.Request.url=f.Request.url||f.vanilla.locationShort;b.storeState(f);b.trigger(g,"request");g={data:f.Request.data,url:f.Request.url,type:"post",success:function(l){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);l=c.extend(true,{},b.defaults.State.Response.data,l);l.Ajaxy=l.Ajaxy||{};if(l.Ajaxy.redirected){var m=b.extractState(l.Ajaxy.redirected.to);
b.redirected={status:true,from:a,to:m};d.go(m)}b.ajaxQueue.shift();if((m=b.ajaxQueue.pop())&&m!==a){b.ajaxQueue=[];b.stateChange(m);return false}f.Response.data=l;f.Error.data={};m=l.controller||f.controller||null;if(m===null){m="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[l.controller,f.controller])}if(f.Response.callback)if(f.Response.callback.apply(f,arguments)||m==="callback")return true;
return b.trigger(m,"response",f)},error:function(l,m,r,o){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);o||(o={responseText:l.responseText.trim()||false});b.ajaxQueue.shift();var p=b.ajaxQueue.pop();if(p&&p!==a){b.ajaxQueue=[];b.stateChange(p);return false}f.Request.XMLHttpRequest=l;f.Response.data=o;f.Error.data={};p=o.controller||f.controller||null;if(p===null){p="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",
[this,arguments],[o.controller,f.controller])}if(f.Error.callback)if(f.Error.callback.apply(f,arguments)||p==="callback")return true;return b.trigger(p,"error",f)},complete:function(l){b.options.debug&&window.console.debug("Ajaxy.request.complete:",[this,arguments]);f.Request.XMLHttpRequest=l}};if(f.form){var h=c(f.form);if(h.attr("enctype")==="multipart/form-data"){e="ajaxy_form_iframe_"+Math.floor(Math.random()*99999);var j=c('<iframe style="display:none" src="about:blank" id="'+e+'" name="'+e+
'" >').appendTo("body").hide(),i=c('<input type="hidden" name="ajax" value="true"/>').appendTo(h),n=c('<input type="hidden" name="Ajaxy[form]" value="true"/>').appendTo(h);j.bind("load",function(){if((this.document||this.currentDocument||this.contentWindow.document).location.href==="about:blank")return true;var l=j.contents().find(".response").val(),m=false;try{m=c.parseJSON(l)}catch(r){window.console.error("Ajaxy.request.form: Invalid Response.",[this,arguments],[l])}m?request.success(m):request.error(m);
h.removeAttr("target");j.remove();i.remove();n.remove()});h.attr("target",e);h.submit();var k=h.values();g.data=c.extend(true,g.data,k||{});e=true}else{k=h.values();g.data=c.extend(true,g.data,k||{})}}k=true;f.Request=g;e||(k=b.ajax(g));return k}},htmlCompat:function(a){return String(a).replace(/<\!DOCTYPE[^>]*>/i,"").replace(/<(html|head|body|title|meta)/gi,'<div id="ajaxy-$1"').replace(/<\/(html|head|body|title|meta)/gi,"</div")},ajax:function(a){var b=c.Ajaxy;b.options.debug&&window.console.debug("Ajaxy.ajax:",
...
b.options.relative_url=""}b.options.root_url=b.options.root_url.replace(/\/+$/,"");b.options.base_url=b.options.base_url.replace(/\/+$/,"");b.options.relative_url=b.extractRelativeUrl(b.options.relative_url);if(b.options.root_url==="/")b.options.root_url="";if(b.options.base_url==="/")b.options.base_url="";if(b.options.relative_url==="/")b.options.relative_url="";b.options.debug&&window.console.debug("Ajaxy.configure:",[this,arguments]);if(b.options.relative_url&&b.options.relative_url!==null)if(b.options.redirect===
true){var f=b.options.root_url+b.options.base_url+"#"+b.options.relative_url;if(d=d.getHash())f+="?anchor="+d;document.location=f}else if(b.options.redirect==="postpone")b.postpone=true;else if(b.options.redirect==="disable"){b.addAjaxy=b.ajaxify=b.bind=function(){};c(function(){c(".ajaxy").removeAjaxy()})}b.bind(e);b.configured=true;b.onReady();return true}},onReady:function(a){var b=c.Ajaxy;if(typeof a==="undefined"){if(b.configured&&b.onReadyHandlers.length){c.each(b.onReadyHandlers,function(d,
e){e.call(b)});b.onReadyHandlers=[]}}else if(typeof a==="function")b.configured?a.call(b):b.onReadyHandlers.push(a);return b},construct:function(){var a=c.Ajaxy,b=c.History;if(!a.constructed){a.constructed=true;b.bind(function(d){return a.stateChange(d)});c.Sparkle&&c.Sparkle.addExtension("ajaxy",function(){c(this).ajaxify()});c.fn.ajaxy=a.fn.ajaxify;c.each(a.fn,function(d,e){c.fn[d]=e});a.onReady(function(){c(function(){a.domReady()})});return true}},domReady:function(){c.Ajaxy.options.auto_ajaxify&&
c("body").ajaxify();return true},fn:{ajaxify:function(){var a=c.Ajaxy,b=c(this);c.each(a.Controllers,function(f){a.ajaxifyController(f)});if(a.options.track_all_internal_links){var d=b.findAndSelf("a[href^=/],a[href^=./]");if(a.options.root_url){var e=c("a[href^="+a.options.root_url+"]");d=d.add(e);delete e}d=d.filter(":not(.ajaxy,.no-ajaxy)").addClass("ajaxy");delete d}a.options.track_all_anchors&&b.findAndSelf("a[href^=#]:not(.ajaxy,.no-ajaxy)").addClass("ajaxy");b.addAjaxy();return b},addAjaxy:function(){var a=
c.Ajaxy,b=c(this);b.is("form,a")&&b.addClass("ajaxy");b.findAndSelf("a.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("click",a.ajaxifyHelpers.a);b.findAndSelf("form.ajaxy:not(.ajaxy-has)").addClass("ajaxy-has").once("submit",a.ajaxifyHelpers.form);return b},removeAjaxy:function(a){var b=c.Ajaxy,d=c(this);a=c.extend({permanently:true},a);var e=d.findAndSelf("a.ajaxy").removeClass("ajaxy ajaxy-has").unbind("click",b.ajaxifyHelpers.a);b=d.findAndSelf("form.ajaxy").removeClass("ajaxy ajaxy-has").unbind("submit",
